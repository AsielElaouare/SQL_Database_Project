...
namespace SomerenUI
{
    public partial class SomerenUI : Form
    {
        ...
        {
            Form form = new ManageParticipants((Activity)listViewActivities.SelectedItems[0].Tag);
            form.Show();
        }
        ...
        private void listViewActivities_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                btnManageParticipants.Enabled = true;
                manageSupervisorsButton.Enabled = true;
            }
            else
            {
